        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                    ...
                    <img src="{{ asset('assets/images/avatars/avatar-default.jpg') }}" class="user-img"
                        alt="user avatar">
                    <div class="user-info ps-3">
                        @if (Str::length(Auth::guard('student')->user()) > 0)
                            <p class="mb-0 user-name">{{ Auth::guard('student')->user()->nama_lengkap }}</p>
                        @elseif(Str::length(Auth::guard('user')->user()) > 0)
                            <p class="mb-0 user-name">{{ Auth::guard('user')->user()->nama_lengkap }}</p>
                        @endif
                        <p class="mb-0 designattion">
                            @if (Str::length(Auth::guard('student')->user()) > 0)
