                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:250px;">
                                                            <img alt="" height="auto"
                                                                src="https://i.ibb.co/xH90Vrg/logo-img.png"
                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <div
                                                                ...
                                                                <br><br> Selamat! Kamu <strong
                                                                    style="color: green">Dinyatakan Lulus</strong>
                                                                pendaftaran PPDB PAUD Tunas Aksara. <br>
                                                                Selanjutnya kamu bisa <a
                                                                    href="{{ route('login') }}">login</a> untuk
                                                                melihat info lebih detail terkait pendidikanmu di PAUD
                                                                Tunas Aksara.
                                                            </div>
                                                        </td>
                                                    </tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                style="font-family:Assistant, Helvetica, Arial, sanf-serif;font-size:18px;line-height:1;text-align:center;color:#888B93;">
                                                {{ date('Y') }} PAUD Tunas Aksara Copyright All Rights Reserved.
                                            </div>
                                        </td>
                                    </tr>
                                </table>
