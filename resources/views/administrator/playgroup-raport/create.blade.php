    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="row row-cols-1 row-cols-md-1 row-cols-lg-1 row-cols-xl-1">
                <div class="col">
                    <h6 class="mb-0 text-uppercase">Tambah Nilai / Raport Peserta Didik</h6>
                    <hr>
                    <div class="card">
                        <div class="card-body">
                                                ...
                                                <tbody>
                                                    ...
                                                    <div class="behavior_formations">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center" colspan="4">
                                                                <select id="point_2" name="point_2" class="form-select">
                                                                    @foreach ($predicates as $predicate)
                                                                        <option value="{{ $predicate->nama }}">
                                                                            {{ $predicate->nama }}
                                                                        </option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td colspan="4">
                                                            <div class="mb-5 d-flex justify-content-end fixed-bottom me-5">
                                                                <button type="submit"
