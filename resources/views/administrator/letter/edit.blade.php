                                ...
                                <div class="card-body">
                                    <form action="{{ route('letter.update', $letter->id) }}" method="POST"
                                        ...
                                        <div class="mb-3 row align-items-center">
                                            ...
                                            <div class="col-sm-9 text-secondary @error('asal_surat') is-invalid @enderror">
                                                <input type="text" name="asal_surat" id="asal_surat" class="form-control"
                                                    value="{{ old('asal_surat', $letter->asal_surat) }}" />
                                            </div>
                                        ...
                                        <div class="mb-3 row align-items-center">
                                            ...
                                            <div class="col-sm-9 text-secondary @error('no_surat') is-invalid @enderror">
                                        ...
                                        <div class="mb-3 row align-items-center">
                                            ...
                                            <div class="col-sm-9 text-secondary @error('tujuan') is-invalid @enderror">
                                                <input type="text" name="tujuan" id="tujuan" class="form-control"
                                                    value="{{ old('tujuan', $letter->tujuan) }}" />
                                            </div>
                                        ...
                                        <div class="mb-3 row align-items-center">
                                            ...
                                            <div class="col-sm-9 text-secondary @error('no_surat') is-invalid @enderror">
                                                <input type="date"
                                                    ...
                                                    value="{{ old('tanggal_surat', $letter->tanggal_surat) }}">
                                            </div>
                                            @error('tanggal_surat')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <select class="form-select @error('jenis_surat') is-invalid @enderror"
                                                    ...
                                                    @foreach ($categories as $category)
                                                        @if (old('jenis_surat', $letter->letter_category_id) == $category->id)
                                        ...
                                        <div class="mb-3 row align-items-center">
                                            ...
                                            <div class="col-sm-9 text-secondary @error('keterangan') is-invalid @enderror">
                                                <input id="keterangan" type="hidden" name="keterangan"
                                                    value="{{ old('keterangan', $letter->keterangan) }}">
                                        ...
                                        <div class="mb-3 row align-items-center">
                                            ...
                                            <div class="col-sm-9 text-secondary @error('image') is-invalid @enderror">
                                                <input type="hidden" name="oldImage" value="{{ $letter->image }}">
