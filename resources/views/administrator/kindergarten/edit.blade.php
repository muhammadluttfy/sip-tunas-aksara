            ...
            <div class="card">
                <div class="p-4 card-body">
                    ...
                    <div id="smartwizard">
                        ...
                        <form action="{{ route('kindergarten.update', $student->username) }}" method="POST"
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <textarea class="form-control @error('alamat_murid') is-invalid @enderror" name="alamat_murid" id="alamat_murid"
                                                                rows="3" placeholder="Masukkan detail alamat atau nama jalan..." required>{{ old('alamat_murid', $student->student_detail->alamat) }}</textarea>
                                                            @error('alamat_murid')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <textarea class="form-control @error('alamat_ayah') is-invalid @enderror" name="alamat_ayah" id="alamat_ayah"
                                                                rows="3" placeholder="Masukkan detail alamat atau nama jalan..." required>{{ old('alamat_ayah', $student->father->alamat) }}</textarea>
                                                            @error('alamat_ayah')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <textarea class="form-control @error('alamat_ibu') is-invalid @enderror" name="alamat_ibu" id="alamat_ibu"
                                                                rows="3" placeholder="Masukkan detail alamat atau nama jalan..." required>{{ old('alamat_ibu', $student->mother->alamat) }}</textarea>
                                                            @error('alamat_ibu')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
