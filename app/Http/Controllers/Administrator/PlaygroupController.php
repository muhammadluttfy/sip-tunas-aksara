...
class PlaygroupController extends Controller
{
    ...
    public function graduatedUpdate(Request $request, Student $student, StudentDetail $student_detail)
    {
        $request->validate([
        ...
        Student::where('id', $student->id)->update([
            'level_id' => $request->jenjang_pendidikan,
        ]);
        ...
        return redirect()->route('playgroup.index')->with('success', 'Peserta didik sudah dinyatakan lulus KB Tunas Aksara!');
    }
}
